...
Foomo\HTMLDocument::getInstance()->addStylesheets(array(
	'//fonts.googleapis.com/css?family=Ubuntu:regular,bold&v1',
			...
			<? if (Foomo\Config::getMode() != Foomo\Config::MODE_PRODUCTION): ?>
				...
				<? elseif ($model->serializer instanceof Foomo\Services\RPC\Serializer\AMF): ?>
					<? if (Foomo\Modules\Manager::isEnabled('Foomo.Zugspitze')): ?>
						...
						<b>Zugspitze:</b> &nbsp; <a
								href="<?= Foomo\Utils::getServerUrl() . \Foomo\ROOT_HTTP ?>/index.php/Foomo/showMVCApp/Foomo.Zugspitze.ProxyGenerator/default"
								target="_top">Proxy Generator</a>
					<? endif; ?>
					<? if (Foomo\Modules\Manager::isEnabled('Foomo.Zugspitze.Backport')): ?>
						<? // @todo make it possible to link to other apps ?>
						<b>Zugspitze Backport:</b> &nbsp; <a
								href="<?= Foomo\Utils::getServerUrl() . \Foomo\ROOT_HTTP ?>/index.php/Foomo/showMVCApp/Foomo.Zugspitze.Backport.ProxyGenerator/default"
								target="_top">Proxy Generator</a>
					<? endif; ?>
				<? else: ?>
